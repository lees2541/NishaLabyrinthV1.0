...
execute as @a[team=explorer,tag=police,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick"}}] at @s anchored eyes run function nishalabyrinth:system/hitboxes/ray
...
execute if entity @a[team=gate_keeper,scores={NL_being_lighted=45},tag=!unstoppable] run effect give @a[team=explorer,tag=police] speed 5 0 true
