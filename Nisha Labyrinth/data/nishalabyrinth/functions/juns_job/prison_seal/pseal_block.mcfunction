...
team join prisoner @a[team=explorer,advancements={nishalabyrinth:system/location/in_the_prison=true}]
advancement revoke @a[team=explorer,advancements={nishalabyrinth:system/location/in_the_prison=true}] only nishalabyrinth:system/location/in_the_prison
