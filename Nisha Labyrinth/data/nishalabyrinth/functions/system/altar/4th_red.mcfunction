#setblock 675 40 579 minecraft:redstone_block replace
execute at @a run playsound minecraft:alarm master @a ~ ~ ~ 3
scoreboard players set r NL_red_progress 4
scoreboard players set r NL_red_progress_left 6
advancement grant @a only nishalabyrinth:system/4th
...
title @a title [{"text":"5개 남았습니다","color":"dark_red","bold":true}]
