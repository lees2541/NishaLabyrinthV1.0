bossbar set nl:lib_alarm color purple
scoreboard players set r NL_lib_alarm 5000
scoreboard players set r NL_altar_status_adv 1
scoreboard players set r NL_lib_alarm_status 1
loot give @a[team=gate_keeper] loot minecraft:command/item/library/tp_lib_orb
